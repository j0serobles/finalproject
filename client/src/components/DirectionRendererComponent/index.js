...
class DirectionRendererComponent extends Component {
  state = {
    directions: null,
    wayPoints: null,
  ...
  componentDidMount() {
    ...
    // console.log ("DirectionRendererComponent[18]" + JSON.stringify(this.state, '', 2));
    //this.setCurrentLocation();
  }

  /* Calls the DirectionsService() to update the directions and waypoints in the state.
   * keep trying every 200ms if over query limit
   */
